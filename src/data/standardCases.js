...
export const standardCases = Object.freeze([
  ...
  Object.freeze({ id: 'hcl-naoh-90-percent', label: '90% Veq', CaM: 0.1, VaMl: 25, CbM: 0.1, VbMl: 22.5, temperatureC: 25 }),
  ...
  Object.freeze({ id: 'hcl-naoh-110-percent', label: '110% Veq', CaM: 0.1, VaMl: 25, CbM: 0.1, VbMl: 27.5, temperatureC: 25 }),
